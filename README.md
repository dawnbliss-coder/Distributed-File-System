### NOTE :
->All code is generated by llm. 

This project implements a **distributed, sentence-level, multi-user file storage system**, featuring fine-grained locking, concurrent editing, access control, and fault tolerance across three main components: **Client**, **NameServer**, and **StorageServer**.
